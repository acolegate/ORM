...
{
	internal class SqlStoredProcedureParameter : ISqlColumn
	{
		/// <summary>
		/// Initializes a new instance of the <see cref="SqlStoredProcedureParameter" /> class.
		/// </summary>
		/// <param name="sqlName">Name of the SQL.</param>
		/// <param name="sqlDbType">Type of the SQL db.</param>
		public SqlStoredProcedureParameter(string sqlName, SqlDbType sqlDbType)
		{
			SqlName = sqlName;
