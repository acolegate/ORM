...
{
	internal class SqlStoredProcedureColumn : ISqlColumn
	{
		/// <summary>
		/// Initializes a new instance of the <see cref="SqlStoredProcedureColumn" /> class.
		/// </summary>
		/// <param name="sqlName">Name of the SQL.</param>
		/// <param name="sqlDbType">Type of the SQL db.</param>
		public SqlStoredProcedureColumn(string sqlName, SqlDbType sqlDbType)
		{
			SqlName = sqlName;
